...
public class UserController implements IUserController {
    ...
    public ResponseEntity<String> register(@Valid @RequestBody CreateUserDTO createUserDTO) throws UserAlreadyExistsException {
        this.userService.createUser(createUserDTO);
        return ResponseEntity.ok("User created successfully");
    }

    @PostMapping("/login")
    public ResponseEntity<ResponseUserDTO> login(@Valid @RequestBody CreateUserDTO request) {
